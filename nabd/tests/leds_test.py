    ...
    def test_pulse(self):
        ...
        self.assertEqual(
            ...
            [
                ...
                "do_show",
                ("do_set", Led.BOTTOM, 5, 11, 16),
                "do_show",
                ("do_set", Led.BOTTOM, 6, 12, 17),
                "do_show",
                ...
                "do_show",
                ("do_set", Led.BOTTOM, 7, 15, 22),
                "do_show",
                ("do_set", Led.BOTTOM, 8, 16, 23),
                "do_show",
                ("do_set", Led.BOTTOM, 8, 16, 25),
                "do_show",
            ],
        )
